...
Pelo que vimos na subseção anterior, isto nos diz que um intervalo de confiança de nível x:[\alpha] para
a média é dado por
[latexmath]
++++
\[
...
um intervalo de confiança de nível x:[\alpha] para a proporção é dado por
[latexmath]
++++
\[
