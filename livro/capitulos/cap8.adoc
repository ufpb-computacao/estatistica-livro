...
++++
\[
\frac{\partial \sum_{i=1}^n e_i}{\partial a} = -2 \sum_{i=1}^n (Y_i-a-bX_i),
\]
++++
e
[latexmath]
++++
\[
\frac{\partial \sum_{i=1}^n e_i}{\partial b} = -2 \sum_{i=1}^n (Y_i-a-bX_i)X_i.
\]
++++
...
++++
\[
-2\sum_{i=1}^n (Y_i-\widehat{a}-\widehat{b}X_i) = 0 \Rightarrow \sum_{i=1}^n Y_i - n\widehat{a} - \widehat{b}\sum_{i=1}^n X_i = 0 \Rightarrow \frac{1}{n}\sum_{i=1}^n Y_i = \widehat{a} + \widehat{b} \frac{1}{n}\sum_{i=1}^n X_i \Rightarrow \widehat{a} = \overline{Y} - \widehat{b}\overline{X}.
\]
++++
