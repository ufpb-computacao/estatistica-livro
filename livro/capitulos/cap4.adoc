...
+
--
.. Temos da definição de latexmath:[$f(x)$] que para todo latexmath:[$x$] real, latexmath:[$f(x)\geq 0$]. 
...
[latexmath]
++++
\[P(Y=1) = P(X\in \{2,4,6,\ldots\}) = (1/2)^2+(1/2)^4+(1/2)^6 +\cdots = 1/4 + (1/4)^2 + (1/4)^3 + \cdots = \frac{1/4}{1-1/4} = 1/3.\]
++++
