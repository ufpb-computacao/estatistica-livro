...
[latexmath]
++++
\[\Omega = \{VVVV,VVVA,VVAV,VAVV,AVVV,VVAA,VAVA,VAAV,AVAV,AAVV,AVVA,VAAA,AVAA,AAVA,AAAV,AAAA\}.\]
++++
...
\[
\begin{array}{lll}
p(1) &=&P (X=1)= P(AAAV,AAVA,AVAA,VAAA) = P(AAAV)+P(AAVA)+P(AVAA)+P(VAAA)\\
...
&=& (0,6)^2(0,4)^2+(0,6)^2(0,4)^2+(0,6)^2(0,4)^2+(0,6)^2(0,4)^2+(0,6)^2(0,4)^2+(0,6)^2(0,4)^2\\
&=& 6(0,6)^2(0,4)^2;
\end{array}
\]
++++
...
\[
\begin{array}{lll}
p(3)&=&P(X=3) =P(VVVA,VVAV,VAVV,AVVV) = P(VVVA)+P(VVAV)+P(VAVV)+P(AVVV)\\
&=& (0,4)^30,6+(0,4)^30,6+(0,4)^30,6+(0,4)^30,6 = 4(0,4)^30,6;
\end{array}
\]
++++
